...
public class SnapScrolling : MonoBehaviour
{
    ...
    //public List<GameObject> instPans;
    ...
    private void Start()
    {
        ...
        for (int i = 0; i < panCount; i++)
        {
            ...
            if (i == 0) continue;
            instPans[i].transform.localPosition = new Vector2(instPans[i - 1].transform.localPosition.x + prefabs[i].GetComponent<RectTransform>().sizeDelta.x + panOffset,
